...
const vitalsData = [
    { label: 'Blood Pressure', value: '128/82 mmHg', status: 'normal', time: '08:30' },
    { label: 'Heart Rate', value: '76 bpm', status: 'normal', time: '08:30' },
    { label: 'Temperature', value: '37.1 °C', status: 'normal', time: '08:30' },
    { label: 'SpO2', value: '98%', status: 'normal', time: '08:30' },
    { label: 'Respiratory Rate', value: '18 /min', status: 'normal', time: '08:30' },
    { label: 'Blood Glucose', value: '142 mg/dL', status: 'elevated', time: '09:15' },
];

const labsData = [
    { test: 'HbA1c', result: '7.2%', ref: '< 5.7%', flag: 'HIGH', time: '2026-05-13' },
    { test: 'Fasting Glucose', result: '118 mg/dL', ref: '70–99', flag: 'HIGH', time: '2026-05-13' },
    { test: 'Cholesterol (Total)', result: '195 mg/dL', ref: '< 200', flag: null, time: '2026-05-13' },
    { test: 'eGFR', result: '82 mL/min', ref: '> 60', flag: null, time: '2026-05-13' },
    { test: 'Hemoglobin', result: '13.8 g/dL', ref: '12–17', flag: null, time: '2026-05-13' },
];
                    ...
                    <div className="flex-1 overflow-y-auto p-6 flex flex-col bg-[#0B0F1A]/50">
                        ...
                        {activeTab === 'prescriptions' && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3 text-left">
                                {[
                                    { name: 'Metformin 500mg', dose: 'Twice daily with meals', prescriber: 'Dr. R. Chen', date: '2026-05-10', status: 'Active' },
                                    { name: 'Atorvastatin 20mg', dose: 'Once daily at night', prescriber: 'Dr. R. Chen', date: '2026-05-10', status: 'Active' },
                                    { name: 'Aspirin 81mg', dose: 'Once daily', prescriber: 'Dr. A. Patel', date: '2026-04-01', status: 'Active' },
                                ].map(rx => (
                        ...
                        {activeTab === 'notes' && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-left">
                                <div className="space-y-4">
                                    {[
                                        { date: '2026-05-14 08:30', author: 'Dr. R. Chen', text: 'Patient presents with stable vitals. Blood glucose slightly elevated at 142 mg/dL. Reviewing HbA1c results from yesterday. Plan to adjust Metformin dosage if levels do not improve by next visit.' },
                                        { date: '2026-05-12 14:15', author: 'Nurse P. Ray', text: 'Administered Metformin 500mg with lunch per schedule. Patient tolerated well. No adverse reactions noted.' },
                                    ].map((note, i) => (
